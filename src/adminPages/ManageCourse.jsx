...
const ManageCourse = () => {
    ...
    const [formData, setFormData] = useState({ field1: '', field2: '', field3: '', field4: '', field5: '', field6: 'undergraduate' });
    const [photoFile, setPhotoFile] = useState(null);
    
    const handleOpenModal = () => {
        setEditId(null);
        setShowModal(true);
        setFormData({ field1: '', field2: '', field3: '', field4: '', field5: '', field6: 'undergraduate' });
        setPhotoFile(null);
    }
    ...
    const handleEdit = (course) => {
        ...
        setFormData({
            ...
            field6: course.level || 'undergraduate'
        });
        setPhotoFile(null);
        setShowModal(true);
    }
    ...
    const handleCreateCourse = async (e) => {
        ...
        try {
            ...
            data.append('level', formData.field6);
    ...
    return (
        <div className='p-5 bg-[#f5f4f4] flex flex-col gap-5 min-h-screen relative'>
            ...
            {loading ? (
                ...
                <ManageTable
                    columns={["name", "level", "duration", "eligibility", "fee", "description"]}
                    data={filteredData}
                    onEdit={handleEdit}
            ...
            <DialogBox
                ...
                fields={[
                    ...
                    { label: "Level", name: "field6", type: "radio", options: [
