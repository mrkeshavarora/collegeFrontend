        ...
        <div>
            <SmallBlueStrap head="Gallery" line="A visual journey through our campus, events, and student life." />
             <div className="px-4 md:px-14 pb-20">
                <div className="rounded-3xl relative z-40 -mt-10 md:-mt-20 top-5 gap-6 md:gap-8 max-w-8xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 min-h-[50vh]">
                    {loading ? (
